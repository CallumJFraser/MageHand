...
describe('Manager - Character:', function(){
	...
	describe('GetByAccount:', function(){
		...
		it('Valid:', function(done){
			manager.GetByAccount(valid, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Reason, undefined);
		...
		it('Invalid "ID" Value:', function(done){
			manager.GetByAccount(invalid, function(err, result){
				assert.notEqual(result, undefined);
				assert.notEqual(result.Reason, undefined);
		...
		it('Invalid "ID" Format:', function(done){
			manager.GetByAccount(invalidFormat, function(err, result){
				assert.notEqual(result, undefined);
				assert.notEqual(result.Reason, undefined);
				assert.equal(result[0], undefined);
				done();
		...
		it('Missing "ID":', function(done){
			manager.GetByAccount(blank, function(err, result){
				assert.notEqual(result, undefined);
				assert.notEqual(result.Reason, undefined);
				assert.equal(result[0], undefined);
				done();
