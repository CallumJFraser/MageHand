...
describe('Account Manager:', function(){
	...
	describe('GetByUsername:', function(){
		...
		it('Valid:', function(done){
			manager.GetByUsername(valid, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Success, true);
				assert.equal(result.Reason, undefined);
				assert.equal(result.ID, validObject.ID);
		...
		it('Invalid:', function(done){
			manager.GetByUsername(invalid, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Success, false);
				assert.notEqual(result.Reason, undefined);
				assert.equal(result.ID, undefined);
		...
		it('Missing "Username":', function(done){
			manager.GetByUsername(blank, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Success, false);
				assert.notEqual(result.Reason, undefined);
				assert.equal(result.ID, undefined);
	...
	describe('GetByEmail:', function(){
		...
		it('Valid:', function(done){
			manager.GetByEmail(valid, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Success, true);
				assert.equal(result.Reason, undefined);
				assert.equal(result.ID, validObject.ID);
		...
		it('Invalid:', function(done){
			manager.GetByEmail(invalid, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Success, false);
				assert.notEqual(result.Reason, undefined);
				assert.equal(result.ID, undefined);
		...
		it('Missing "Username":', function(done){
			manager.GetByEmail(blank, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Success, false);
				assert.notEqual(result.Reason, undefined);
				assert.equal(result.ID, undefined);
	...
	describe('Search:', function(){
		...
		it('Valid:', function(done){
			manager.Search(valid, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Success, true);
				assert.equal(result.Reason, undefined);
				assert.equal(result.ID, validObject.ID);
		...
		it('Invalid:', function(done){
			manager.Search(invalid, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Success, false);
				assert.notEqual(result.Reason, undefined);
				assert.equal(result.ID, undefined);
		...
		it('Missing "Username":', function(done){
			manager.Search(blank, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Success, false);
				assert.notEqual(result.Reason, undefined);
				assert.equal(result.ID, undefined);
	...
	describe('Create:', function(){
		...
		it('Valid:', function(done){
			manager.Create(valid, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Success, true);
				assert.equal(result.Reason, undefined);
		...
		it('Invalid:', function(done){
			manager.Create(invalid, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Success, false);
				assert.notEqual(result.Reason, undefined);
				assert.equal(result.ID, undefined);
		...
		it('Missing "Username":', function(done){
			manager.Create(missing, function(err, result){
				assert.notEqual(result, undefined);
				assert.equal(result.Success, false);
				assert.notEqual(result.Reason, undefined);
				assert.equal(result.ID, undefined);
