...
describe('GetAbility -', function(){
	...
	describe('Valid call:', function(){
		it('Should return Success:true', function(done){
			dndAPI.Login(validUsername, validPassword, function(loginResponse){
				...
				dndAPI.GetAbility(authObject, 1, function(result){
	...
	describe('Invalid call (missing param: "RaceID"):', function(){
		it('Should return a Result', function(done){
			dndAPI.Login(validUsername, validPassword, function(loginResponse){
				authObject.SessionID = loginResponse.SessionID;
				dndAPI.GetAbility(authObject, undefined, function(result){
					assert.notEqual(result.Result, undefined);
					done();
				});
			});
...
describe('ListCharacterAbilities -', function(){
	...
	describe('Valid search by full Title:', function(){
		it('Should return Success:true', function(done){
			dndAPI.Login(validUsername, validPassword, function(loginResponse){
				authObject.SessionID = loginResponse.SessionID;
				dndAPI.ListCharacterAbilities(authObject, validSearchFullTitle, function(result){
					assert.equal(result.Auth.Success, true);
					done();
				});
			});
	...
	describe('Valid search by partial Title:', function(){
		it('Should return Success:true', function(done){
			dndAPI.Login(validUsername, validPassword, function(loginResponse){
				authObject.SessionID = loginResponse.SessionID;
				dndAPI.ListCharacterAbilities(authObject, validSearchPartialTitle, function(result){
					assert.equal(result.Auth.Success, true);
					done();
				});
			});
	...
	describe('Valid search by Description:', function(){
		it('Should return Success:true', function(done){
			dndAPI.Login(validUsername, validPassword, function(loginResponse){
				authObject.SessionID = loginResponse.SessionID;
				dndAPI.ListCharacterAbilities(authObject, validSearchDescription, function(result){
					assert.equal(result.Auth.Success, true);
					done();
				});
			});
	...
	describe('Valid call (missing param: "Search"):', function(){
		it('Should return a Result', function(done){
			dndAPI.Login(validUsername, validPassword, function(loginResponse){
				authObject.SessionID = loginResponse.SessionID;
				dndAPI.ListCharacterAbilities(authObject, undefined, function(result){
					assert.notEqual(result.Result, undefined);
					done();
				});
			});
